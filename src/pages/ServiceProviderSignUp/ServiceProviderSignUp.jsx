            ...
            {step === 0 && (
                <div className='firstStep'>
                    <div className="input_container">
                        ...
                        <input placeholder="Tom" title="Inpit title" name="input-name" type="text" className="input_field" id="email_field" required/>
                    </div>
                    ...
                    <div className="input_container">
                        ...
                        <input placeholder="Holland" title="Inpit title" name="input-name" type="text" className="input_field" id="email_field" required/>
                    </div>
                    ...
                    <div className="input_container">
                        ...
                        <input placeholder="name@mail.com" title="Inpit title" name="input-name" type="text" className="input_field" id="email_field" required/>
                    </div>
                    ...
                    <div className="input_container">
                        ...
                        <input placeholder="Password" title="Input password" name="input-name" type="password" className="input_field" id="password_field" required/>
                    </div>
                </div>
