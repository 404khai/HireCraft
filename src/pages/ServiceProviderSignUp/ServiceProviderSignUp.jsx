...
const ServiceProviderSignUp = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const registerPayload = {
            ...
            role: formData.role // "SERVICE_PROVIDER"
        };
  ...
  return (
    <div className="serviceProviderFormContainer">
        ...
        <form className="signup_form_container">
            ...
            {step === 2 && (
                <div className="fourthStep">
                    ...
                    <div className="input_container">
                        ...
                        <input placeholder="Plumber" title="Input occupation" name="input-name" type="text" className="signup_input_field" id="email_field" required/>
                    </div>
                </div>
            )}
            ...
            <button title="Sign Up" type="submit" className="signUpBtn" onClick={handleSubmit}>
                <span>Register</span> 
            </button>
