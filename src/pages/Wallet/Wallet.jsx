          ...
          <div className="wallet">
            ...
            <div className="walletOverview">
                    ...
                    {/* <svg viewBox="0 0 22.16 22.16" xmlns="http://www.w3.org/2000/svg" className='walletSvg'>
                        <g data-name="Camada 2" id="Camada_2" >
                            <g data-name="Camada 1" id="Camada_1-2" >
                                ...
                                <path d="M16.59,11a5.58,5.58,0,1,0,5.58,5.58A5.58,5.58,0,0,0,16.59,11Zm0,10.15a4.57,4.57,0,1,1,4.57-4.57A4.57,4.57,0,0,1,16.59,21.15Z"></path>
                                <path d="M13,6.09h7.41L19.12,7.4a.51.51,0,0,0,.72.72L22,5.94h0a.49.49,0,0,0,.14-.35.51.51,0,0,0,0-.19A.52.52,0,0,0,22,5.22L19.83,3a.51.51,0,0,0-.72.72l1.32,1.32H13a.51.51,0,1,0,0,1Z"></path>
                                <path d="M9.14,16.08H1.73L3,14.76A.51.51,0,0,0,2.33,14L.15,16.23a.5.5,0,0,0-.11.16.5.5,0,0,0,0,.39.5.5,0,0,0,.1.16h0l2.18,2.18A.51.51,0,1,0,3,18.41L1.73,17.09H9.14a.51.51,0,0,0,0-1Z"></path>
                            </g>
                        </g>
				    </svg> */}
                </div>
                ...
                <div className="totalEarnings">
                    ...
                    <i><TbMoneybag/></i>
                    {/* <svg id="Capa_1" version="1.1" viewBox="0 0 59.998 59.998" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" className='walletSvg'>
                        <g>
