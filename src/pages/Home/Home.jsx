...
const Home = () => {
  ...
  function SampleNextArrow(props) {
        ...
        return (
          <div
            className={className}
            style={{ ...style, display: "block", background: "#553CDF", borderRadius: "50%" }}
            onClick={onClick}
          />
        );
      }
