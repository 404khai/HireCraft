...
// // Helper function to generate a consistent color based on a string (like a user's name)
// // This ensures the same user always gets the same background color for their initials.
