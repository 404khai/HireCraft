      ...
      <button className="button" onClick={{ onClick }}>
        ...
        <div className="state state--default">
          ...
          <span className='letterSpan'>
            {/* Corrected inline style for CSS variable --i */}
...
const StyledWrapper = styled.div`
  ...
  .button:hover .letterSpan span {
    opacity: 1;
    animation: wave 0.5s ease forwards calc(var(--i) * 0.02s);
  }
  .button:focus .letterSpan span {
    opacity: 1;
  ...
  .state--default span:nth-child(4), .state--default span:nth-child(7) {
    margin-right: 5px;
  }
  .state--sent {
    display: none;
...
export default SendJobRequestBtn;
